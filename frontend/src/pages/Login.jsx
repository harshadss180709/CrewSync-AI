    ...
    <div className="min-h-screen bg-dark-950 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-[1.6rem] font-bold text-white leading-tight">
            Welcome back
          </h1>
        ...
        <div className="
          ...
          rounded-2xl
          p-7
          shadow-[0_8px_48px_rgba(0,0,0,0.45)]
        ">
            ...
            <div>
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  required
                  className="
                    w-full bg-dark-700/60 border border-white/[0.08]
                    rounded-xl pl-10 pr-4 py-2.5
                    text-sm text-white placeholder-gray-600
                    outline-none
                    transition-all duration-200
                    focus:border-brand-500/60 focus:bg-dark-700/80
